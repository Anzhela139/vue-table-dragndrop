...
export default {
  ...
  data() {
    return {
      ...
      startWidth: 0,
      cols: [
            { field: 'name', title: 'Наименование еденицы', show: true,   },
            { field: 'cost', title: 'Цена', show: true,   },
            { field: 'amount', title: 'Кол-во', show: true,   },
            { field: 'product_name', title: 'Название товара', show: true,   },
            { field: 'company', title: 'Компания', show: false,   },
            { field: 'price', title: 'Итого', show: true,   },
            { field: 'weight', title: 'Вес', type: 'number', show: false,   },
            { field: 'isActive', title: 'Активен', type: 'bool', show: false,   },
        ]
    }
  },
  methods: {
    ...
    <div class="filter-wrapper">
        ...
        <ul v-if="isOpen" class="filter-list">
            <li v-for="col in cols" :key="col.field">
                <v-checkbox :label="col.title" :checked="!col.hide" @change="col.hide = !$event.target.checked" :color="'#000'" v-model="col.show"></v-checkbox>
            </li>
        </ul>
    </div>
        ...
        <div class="product-table__wrapper">
            <div class="product-table resizable-table" ref="table">
                <div class="product-table__header">
                    ...
                    <div class="cell header-title" data-index="1">
                        <div class="resizer" @mousedown="resizeHandler"></div>
                        Наименование еденицы
                    </div>
                    <div class="cell header-title" data-index="2">
                        <div class="resizer" @mousedown="resizeHandler"></div>
                        Цена
                    </div>
                    <div class="cell header-title" data-index="3">
                        <div class="resizer" @mousedown="resizeHandler"></div>
                        Кол-во
                    </div>
                    <div class="cell header-title" data-index="4">
                        <div class="resizer" @mousedown="resizeHandler"></div>
                        Название товара
                    </div>
                    <div class="cell header-title ls-column" data-index="5">
                        <div class="resizer" @mousedown="resizeHandler"></div>
                        Итого
                    </div>
                </div>
                        ...
                        <SlickItem v-for="(product, index) in products" :key="products.id" :index="index">
                            <div class="product-table__row">
                                ...
                                <div class="product-table__row-body">
                                    <div class="cell body-cell"  data-index="2">
                                        <v-select
                                            :value="product.name"
                                            :items="names"
                                            variant="outlined"
                                    ...
                                    <div class="cell body-cell"  data-index="3">
                                        <v-text-field 
                                        :value="product.cost"
                                        variant="outlined"
                                        ></v-text-field>
                                    </div>
                                    <div class="cell body-cell"  data-index="4">
                                        <v-text-field 
                                        :value="product.amount"
                                        variant="outlined"
                                        ></v-text-field>
                                    </div>
                                    <div class="cell body-cell"  data-index="5">
                                        <v-select
                                    ...
                                    <div class="cell body-cell ls-column" data-index="6">
                                        <v-text-field 
