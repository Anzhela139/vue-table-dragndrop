<script>
    ...
    export default {
        ...
        data() {
            ...
            total_rows: 0,
            rows: null,
            params: { current_page: 1, pagesize: 10, sort_column: 'id', sort_direction: 'asc' },
            cols: [
                { field: 'id', title: '', isUnique: true, hide: false, sort: false, headerClass: 'header-title' },
                { field: 'action', title: 'Действие', hide: false, sort: false, headerClass: 'header-title' },
                { field: 'name', title: 'Наименование еденицы', hide: false, sort: false, headerClass: 'header-title' },
                { field: 'cost', title: 'Цена', hide: false, sort: false, headerClass: 'header-title' },
                { field: 'amount', title: 'Кол-во', hide: false, sort: false, headerClass: 'header-title' },
                { field: 'product_name', title: 'Название товара', hide: false, sort: false, headerClass: 'header-title' },
                { field: 'company', title: 'Компания', hide: true, sort: false, headerClass: 'header-title' },
                { field: 'price', title: 'Итого', hide: true, sort: false, headerClass: 'header-title' },
                { field: 'weight', title: 'Вес', type: 'number', hide: true, sort: false, headerClass: 'header-title' },
                { field: 'isActive', title: 'Активен', type: 'bool', hide: true, sort: false, headerClass: 'header-title' },
            ]
            }
        },
        ...
        methods: {
            ...
            async getUsers() {
                try {
                    ...
                    this.products = Array.apply(null, Array(12)).map(function(_, index) { return {
                        "id": index, 
                    ...
                    this.total_rows = this.products.length;
                } catch {}
                        ...
                        <g id="Логистика-Copy-39" transform="translate(-289.000000, -154.000000)" fill="#1253A2">
                            <g id="Group-10" transform="translate(254.000000, 122.000000)">
                                <g id="Кнопка-в-корзину" transform="translate(25.000000, 20.000000)">
                                    <path d="M15.5,12 C15.7761424,12 16,12.2238576 16,12.5 L16,17 L20.5,17 C20.7761424,17 21,17.2238576 21,17.5 C21,17.7761424 20.7761424,18 20.5,18 L16,18 L16,22.5 C16,22.7761424 15.7761424,23 15.5,23 C15.2238576,23 15,22.7761424 15,22.5 L15,17.999 L10.5,18 C10.2238576,18 10,17.7761424 10,17.5 C10,17.2238576 10.2238576,17 10.5,17 L15,16.999 L15,12.5 C15,12.2238576 15.2238576,12 15.5,12 Z" id="Combined-Shape"></path>
                                </g>
                            </g>
                        </g>
                    </g>
